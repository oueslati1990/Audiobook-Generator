#!/usr/bin/env python3
"""Test script for audiobook generation"""
...
def main():
    ...
    print(f"\n{'='*60}")
    print(f"Testing Audiobook Generator")
    print(f"{'='*60}")
    ...
    config = AudiobookConfig(
        tts=TTSConfig(
            provider="coqui",  # Using Edge TTS (class name kept for compatibility)
